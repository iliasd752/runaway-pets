  ...
  return (
    <div className="container d-flex flex-column mt-5 align-items-center">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
         <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://3001-iliasd752-runawaypets-ov9o9dubwfv.ws-us83.gitpod.io/found-pet/${props.qrcode}`}></img>
        </Modal.Body>
        <Modal.Footer>
